<template>
	<view style="margin-left: 20rpx; margin-top: 20rpx;">
		...
		<uv-form :model="model1" :rules="rule1" ref="form1" style="background: white; margin-right: 20rpx;">
			...
			<uv-form-item label="民族" label-width="100rpx" prop="userInfo.nation" :borderBottom="true">
				<uv-input v-model="model1.userInfo.nation" border="none" style="margin-left: 20rpx; margin-right: 20rpx;" :readonly="true"></uv-input>
			</uv-form-item>
			<uv-form-item label="性别" label-width="100rpx" prop="userInfo.sex" :borderBottom="true">
			...
			<uv-form-item label="出生日期" label-width="100rpx" prop="userInfo.bornTime" :borderBottom="true">
...
<script>
	export default {
		...
		onReady() {
			...
			uni.setStorage({
				key: 'token',
				data: 'eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiJiNTE1MTEwYjc2ZDI0NDAyOGQxY2FjODc1MWM1N2FhNiIsInN1YiI6IjYiLCJpc3MiOiJwbSIsImlhdCI6MTcwMjk3Mzc1MiwiZXhwIjoxNzAzMDYwMTUyfQ.EJRhB4xFsTmUd_qTT_0BjwvMrtiHog-OLHbG71wNPHI'
			})
			uni.getStorage({
				key: 'token',
